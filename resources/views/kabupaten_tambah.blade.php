            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="table-responsive">
                        <form action="/kabupaten/kabupaten_store" method="post">
                            {{ csrf_field() }}
                            <p class="kecil">
                                Nama Kabupaten</br><input class="form-control" type="text"
                                    placeholder="Nama Kabupaten" name="nama_kabupaten" required="required">
                                </br>
