            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="/luaspanen">
                            <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
                            Luas Panen
                        </a>
                        <a class="nav-link" href="/produktivitas">
                            <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
                            Produktivitas
                        </a>
        ...
        <div id="layoutSidenav_content" style="background-color:aliceblue">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Halaman Edit Kabupaten</h1>
                    <div class="table-responsive">
                        @foreach ($tb_kabupaten as $kabupaten)
                            <form action="/kabupaten/kabupaten_update" method="post">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $kabupaten->id }}"> <br />
                                Nama Kabupaten </br><input class="form-control" type="text" required="required"
